/*A prime number is an integer that is divisible only by 1 and itself. A porcupine number is a prime number whose last digit is 9
...
public class PorcupineNumber {
    public static void main(String[] args) {
        System.out.print(findProcupineNumber(139));
    }

    static int findProcupineNumber(int n) {
        if (n < 1) {
            return 0;
        }
        int count = 1;
        ...
        while (!isfound) {
            ...
            if (isPrime(n + count) && (n + count) % 10 == 9) {
